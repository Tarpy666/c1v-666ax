# C1V-666AX — Build Plan (next agent brief)

**Genre:** 4x-strategy · **Era inspiration:** 1991 · **Target engine:** web
...
(C1V-666AX). Mechanics are genre conventions; nothing is cloned — no code,
...
3. Depth loop (procedural variety, moddable rules) — modules: TechTree, VictoryCheck.
